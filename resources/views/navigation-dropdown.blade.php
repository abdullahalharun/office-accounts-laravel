            ...
            <div class="flex">
                ...
                <div class="flex-shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        ...
                        <img src="{{ asset('images/Taibah-logo-Final.png') }}" alt="logo" class="block h-9 w-auto" />
                    </a>
                </div>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            ...
            <div class="mt-3 space-y-1">
                ...
                @endif
                <x-jet-dropdown-link href="{{ route('earning.index') }}">
                    Earnings
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="{{ route('deposit.index') }}">
                    Deposit
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="{{ route('statement.index') }}">
                    Statement
                </x-jet-dropdown-link>
                <x-jet-dropdown-link href="/report">
                    Report
                </x-jet-dropdown-link>
